...
@Configuration
@MapperScan(basePackages = {MybatisConfig.BASE_PACKAGE, MybatisConfig.PORT_REPOSITORY_PACKAGE})
public class MybatisConfig {
    public static final String BASE_PACKAGE = "net.slipp.moim.domain";
    public static final String PORT_REPOSITORY_PACKAGE = "net.slipp.moim.port.repository";
